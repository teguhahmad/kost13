  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (backofficeError && backofficeError.code !== 'PGRST116') {
        ...
        const { data: { user }, error: signUpError } = await supabase.auth.signUp({
          ...
          options: {
            data: {
              name: name,
              role: isBackoffice ? 'admin' : 'tenant', // Set role based on registration type
            },
          },
        });
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h1 className="text-3xl font-bold text-center text-blue-600 mb-2">Kostopia</h1>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            >
              {isBackoffice ? 'Kembali ke Login User' : isLogin ? 'Belum punya akun? Daftar' : 'Sudah punya akun? Masuk'}
            </Button>
