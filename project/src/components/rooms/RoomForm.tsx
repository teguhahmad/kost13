...
const RoomForm: React.FC<RoomFormProps> = ({ room, onSubmit, onClose }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === 'type') {
      // When room type is selected, get price and other details from room type
      ...
      if (selectedType) {
        setFormData(prev => ({
          ...
          room_facilities: selectedType.room_facilities,
          bathroom_facilities: selectedType.bathroom_facilities,
          photos: selectedType.photos,
